...
It should choose the first real teacher-generation path for the notes model only, or smoke-test the existing optional training and comparison cells in Colab if that is the active milestone. It should not start coding, writing, work, phone, SaaS, Mac app, or multi-profile features.
