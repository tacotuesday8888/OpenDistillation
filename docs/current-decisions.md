...
- The next GPU evidence run should not repeat the same anti-invention smoke or chase training knobs. It should follow a local diagnosis of the six remaining invented-value misses and must reach at least 3/8 exact held-out fact hits with at most 5/8 invented number/time/identifier/name/color misses.
