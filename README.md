...
The next implementation work is to diagnose why the value-first fact-ledger T4 smoke still hit 0/8 exact facts before spending more GPU. Do not broaden beyond the notes model or build export before the demo flow can show useful note-grounded answers.
