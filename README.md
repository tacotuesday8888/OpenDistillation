...
The next work should diagnose the local fact-ledger learning signal after the failed disambiguation T4 smoke. Do not broaden beyond the notes model, chase training knobs, or build export before the demo flow can show useful note-grounded answers.
