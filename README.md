...
- **Comparison:** optional bounded base-vs-adapter quality report after training; skipped by default and verified locally with fake model dependencies. The multi-question report ran once in Colab on a Tesla T4 with mock-teacher rows; the adapter answers were identical to the base answers, so this proves wiring but not useful learning.
